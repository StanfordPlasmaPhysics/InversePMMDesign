...
s11_tot = [[[np.array([[3.1,9],[3.1,11]]),np.array([1,0,0])],[np.array([[2.9,9],[2.9,11]]),np.array([-1,0,0])]]]
s11_cen = [[np.array([[10.1,9],[10.1,11]]),np.array([1,0,0])]]
...
Total_Flux_crystal = PPC.Get_Total_Flux(['src'], s11_tot, opt = True, rho = rho, plasma = True,\
                                plot = False, wp_max = wpmax, gamma = gamma,\
                                uniform = False)
